...
<!-- 123host added and removed items from sidebar for home page -->
<ul>
    <li><a href="invoices.php?status=Unpaid"><img src="images/icons/invoices.png" class="absmiddle" width="16" height="16" />{$_ADMINLANG.stats.unpaidinvoices}</a></li>
    <li><a href="supporttickets.php?view=Active"><img src="images/icons/support.png" class="absmiddle" width="16" height="16" />Active Tickets</a></li>
    <li><a href="reports.php?report=annual_income_report"><img src="images/icons/reports.png" class="absmiddle" width="16" height="16" />{$_ADMINLANG.billing.income}</a></li>
     <li><a href="reports.php?report=product_suspensions"><img src="images/icons/reports.png" class="absmiddle" width="16" height="16" />Suspensions</a></li>

    <br>
    <li><a href="clientssummary.php?userid=1"><img src="images/icons/search.png" class="absmiddle" width="16" height="16" /> Search Clients</a></li>
    ...
    <li><a href="todolist.php"><img src="images/icons/todolist.png" class="absmiddle" width="16" height="16" /> {$_ADMINLANG.utilities.todolist}</a></li>
